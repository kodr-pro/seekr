use seekr::config::{AppConfig, ProviderConfig, AgentConfig, UiConfig};
use std::fs;
...
fn test_base_url_defaults() {
    assert_eq!(AppConfig::get_default_base_url("gpt-4o"), "https://api.openai.com/v1");
    assert_eq!(AppConfig::get_default_base_url("deepseek-chat"), "https://api.deepseek.com/v1");
    assert_eq!(AppConfig::get_default_base_url("claude-3-opus"), "https://api.anthropic.com/v1");
    assert_eq!(AppConfig::get_default_base_url("nvidia/llama3"), "https://integrate.api.nvidia.com/v1");
    assert_eq!(AppConfig::get_default_base_url("unknown"), "https://api.openai.com/v1");
}
