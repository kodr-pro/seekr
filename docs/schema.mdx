...
| `context_window_threshold` | `40` | Sum of input+output messages before triggering pruning. |
| `context_window_keep` | `10` | Number of most recent messages to keep after pruning. |
| `shell_blocklist` | `[...]` | List of substrings to block in shell commands. |
| `show_shell_warnings` | `true` | Show warnings when running potentially dangerous commands. |
